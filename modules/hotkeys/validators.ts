...
import { FormTags, Hotkey, Scopes, Trigger } from "./types.ts";
import { isHotkeyPressed, isReadonlyArray } from "./is-hotkey-pressed.ts";
import { mapKey } from "./parse-hotkeys.ts";
