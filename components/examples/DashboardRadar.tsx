...
const styles = {
  customSidebar:
    "flex items-center justify-between w-full flex-col h-[calc(var(--theme-line-height-base)*(var(--font-size)*29.5))]",
  customTop: "min-h-[10%] h-full",
  customBottom: "flex-shrink-0 w-full",
  root: "min-w-[56ch]",
  cross:
    "w-[9ch] h-[calc(var(--theme-line-height-base)*(var(--font-size)*7))] my-[calc(var(--theme-line-height-base)*(var(--font-size)*0.5))] flex justify-between flex-col",
  square:
    "w-[4.3ch] h-[calc(var(--theme-line-height-base)*(var(--font-size)*3.4))]",
  ...
  customContent:
    "w-full flex items-center justify-center h-[calc(var(--theme-line-height-base)*(var(--font-size)*24.5))]",
};
