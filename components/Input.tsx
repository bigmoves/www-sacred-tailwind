...
const styles = {
  ...
  displayed:
    "overflow-hidden whitespace-nowrap pointer-events-none break-anywhere bg-[var(--theme-background-input)] shadow-[inset_0_0_0_2px_var(--theme-border)]",
  focused: "has-[.block]:bg-[var(--theme-focused-foreground)]",
  blink: "animate-[blink_1s_step-start_0s_infinite]",
  block:
    "inline-block min-w-[1ch] bg-[var(--theme-text)] text-[var(--theme-background)] h-[calc(var(--font-size)*var(--theme-line-height-base))] align-bottom group-[.focused]:bg-[var(--theme-focused-foreground)]",
  inputContainer: "relative block",
  hidden:
    "absolute top-0 left-0 w-full text-transparent bg-transparent caret-transparent border-none outline-none overflow-hidden p-0 m-0 leading-[var(--theme-line-height-base)] text-[var(--font-size)] font-inherit [-webkit-autofill:shadow-[0_0_0px_1000px_var(--theme-focused-foreground)_inset]]",
};
      ...
      <div className={styles.inputContainer}>
        ...
        >
          ...
          {!isPlaceholderVisible && (
            <span className={clsx(styles.block, isBlink && styles.blink)}>
              {caretChars || ""}
            </span>
          )}
