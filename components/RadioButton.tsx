...
const styles = {
  ...
  right:
    "bg-[var(--theme-button-background)] min-w-[10%] w-full self-stretch pb-[calc(8px*var(--theme-line-height-base))] shadow-[inset_0_1px_0_0_var(--theme-border-subdued)] last:pb-0",
  figure:
    "inline-flex h-[calc(var(--font-size)*var(--theme-line-height-base))] cursor-pointer text-[var(--theme-text)] w-[3ch] items-center justify-center bg-[var(--theme-button-foreground)] group-[.selected]:bg-[var(--theme-text)] group-[.focused]:!bg-[var(--theme-focused-foreground)]",
  ...
  input:
    "absolute h-[1px] w-[1px] opacity-0 bg-transparent border-0 outline-0 m-0 p-0",
};
